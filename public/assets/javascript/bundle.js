...
var CheckMobile = function () {
    function CheckMobile() {
        _classCallCheck(this, CheckMobile);
    }

    _createClass(CheckMobile, [{
        key: "init",
        value: function init() {
...
var _CheckMobile = require('./CheckMobile');
...
var Useful = function () {
    ...
    _createClass(Useful, [{
        ...
        value: function autoScroll() {
            var autoScroll = new _AutoScroll2.default();
            autoScroll.init();
        }
    }, {
        key: 'coords',
        value: function coords() {
            var coords = new _Coords2.default();
            coords.init();
        }
    }, {
        key: 'mobile',
        value: function mobile() {
            var mobile = new _CheckMobile2.default();
            return mobile.init();
        }
    }, {
        key: 'resize',
...
var _Useful2 = _interopRequireDefault(_Useful);
...
function init() {
    ...
    var useful = new _Useful2.default();
    useful.printConsol();
...
},{"./helpers/Useful":6,"./public/PageTransition":10}],8:[function(require,module,exports){
'use strict';
...
var BarbaConfig = function () {
    ...
    * Constructor
    */
   function BarbaConfig(options) {
      _classCallCheck(this, BarbaConfig);
   }

   _createClass(BarbaConfig, [{
      key: 'getLink',
...
},{"barba.js":11}],9:[function(require,module,exports){
'use strict';
...
var BarbaTransition = function () {
  /**
   * Constructor
   */
  function BarbaTransition(options) {
    _classCallCheck(this, BarbaTransition);
  }

  _createClass(BarbaTransition, [{
    key: 'fadeTransition',
...
exports.default = BarbaTransition;

},{"barba.js":11}],10:[function(require,module,exports){
'use strict';
...
var _BarbaConfig2 = require('./BarbaConfig');

var _BarbaConfig3 = _interopRequireDefault(_BarbaConfig2);

var _BarbaTransition = require('./BarbaTransition');

var _BarbaTransition2 = _interopRequireDefault(_BarbaTransition);
...
var PageTransition = function () {
    ...
    _createClass(PageTransition, [{
        ...
        value: function BarbaConfig() {
            ...
            // import help
            this.helper = new _BarbaConfig3.default();
            this.helper.settings();

            this.transition = new _BarbaTransition2.default();
                ...
                if (window.innerWidth > 750) {
                    if (_this.lastClickEl) {
                        if (_this.lastClickEl.getAttribute('class') === null || _this.lastClickEl.getAttribute('class') === "basicTransition" || _this.lastClickEl.classList.contains("basicTransition") || _this.lastClickEl.getAttribute('class') === "header__logo") {
                            return _this.transition.BasicTransition();
                        } else {
                            return _this.transition.fadeTransition();
                        }
                    } else {
                        return _this.transition.fadeTransition();
                    }
...
},{"./BarbaConfig":8,"./BarbaTransition":9,"barba.js":11}],11:[function(require,module,exports){
