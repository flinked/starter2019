 ...
 */
function my_style() {
    wp_register_style( 'style-reveal', THEME_URL .'/public/assets/lib'. '/reveal/css/t-scroll.min.css' , array(), true);
...
function my_script() {
    ...
    wp_register_script( 'reveal', THEME_URL .'/public/assets/lib'. '/reveal/js/t-scroll.min.js' , array(), true);
    wp_register_script( 'pxLoader', THEME_URL .'/public/assets/lib'. '/pxLoader/PxLoader.js' , array(), true);
    wp_register_script( 'pxLoaderImage', THEME_URL .'/public/assets/lib'. '/pxLoader/PxLoaderImage.js' , array(), true);
